...
class Admin::CommentsControllerTest < ActionController::TestCase
  ...
  test "should create admin_comment" do
    assert_difference('Admin::Comment.count') do
      post :create, admin_comment: { comment: @admin_comment.comment, publication_id: @admin_comment.publication_id, user_id: @admin_comment.user_id }
    end
  ...
  test "should update admin_comment" do
    patch :update, id: @admin_comment, admin_comment: { comment: @admin_comment.comment, publication_id: @admin_comment.publication_id, user_id: @admin_comment.user_id }
    assert_redirected_to admin_comment_path(assigns(:admin_comment))
  end
