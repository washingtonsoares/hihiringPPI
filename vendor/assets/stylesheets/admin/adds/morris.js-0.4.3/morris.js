(function() {
  ...
  Morris.Grid = (function(_super) {
    ...
    Grid.prototype.measureText = function(text, angle) {
      ...
      tt = this.raphael.text(100, 100, text).attr('fonts-size', this.options.gridTextSize).attr('fonts-family', this.options.gridTextFamily).attr('fonts-weight', this.options.gridTextWeight).rotate(angle);
      ret = tt.getBBox();
      tt.remove();
      return ret;
    };
    ...
    Grid.prototype.drawYAxisLabel = function(xPos, yPos, text) {
      return this.raphael.text(xPos, yPos, text).attr('fonts-size', this.options.gridTextSize).attr('fonts-family', this.options.gridTextFamily).attr('fonts-weight', this.options.gridTextWeight).attr('fill', this.options.gridTextColor).attr('text-anchor', 'end');
    };
  ...
  Morris.Line = (function(_super) {
    ...
    Line.prototype.drawXAxisLabel = function(xPos, yPos, text) {
      return this.raphael.text(xPos, yPos, text).attr('fonts-size', this.options.gridTextSize).attr('fonts-family', this.options.gridTextFamily).attr('fonts-weight', this.options.gridTextWeight).attr('fill', this.options.gridTextColor);
    };
  ...
  Morris.Bar = (function(_super) {
    ...
    Bar.prototype.drawXAxisLabel = function(xPos, yPos, text) {
      var label;
      return label = this.raphael.text(xPos, yPos, text).attr('fonts-size', this.options.gridTextSize).attr('fonts-family', this.options.gridTextFamily).attr('fonts-weight', this.options.gridTextWeight).attr('fill', this.options.gridTextColor);
    };
  ...
  Morris.Donut = (function(_super) {
    ...
    Donut.prototype.drawEmptyDonutLabel = function(xPos, yPos, color, fontSize, fontWeight) {
      var text;
      text = this.raphael.text(xPos, yPos, '').attr('fonts-size', fontSize).attr('fill', color);
      if (fontWeight != null) {
