 ...
 * exactly this option (note for non-scrolling table, please use the
...
FixedColumns.prototype = {
	 ...
	 * place the cloned header, body or footer table. This effectively gives as 3x3 grid structure.
	 *  @returns {void}
	 *  @private
	 */
